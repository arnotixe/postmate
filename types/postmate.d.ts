...
// seems the module wrapper here is not working if copied to /dist
declare module "@arnotixe.dev/postmate" {
  /**
  ...
  declare namespace Postmate {
    ...
    interface PostmateOptions {
      ...
      /**
       * allow attribute for the created iFrame https://developer.mozilla.org/en-US/docs/Web/API/HTMLIFrameElement/allow
       */
